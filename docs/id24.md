...
Nyan Doom supports some ID24 features, which currently only supported in Classic Doom (Vanilla-MBF21) and Heretic map formats.

UDMF and Hexen do not current support these features.
