...
- Fixed tall post-less patches from temporily freezing the game / drawing incorrectly (example: Anathema)
...
**Menu Tweaks**
- Added a new "revert to default" key (default "r"), which will reset a specific option to it's default setting
