...
- Added "Detailed Rewind Message" option (loosely based on Nugget Doom)
- Added "Detailed Quicksave" option (no avoid a super long quicksave message)
...
- Added Hexen `QUICKEN` and `CONAN` cheats
...
- Added new "Highlight Nyan Features" option which will highlight exclusive Nyan Doom features over it's parent port DSDA-Doom
