...
**Rendering Fixes**
- Fixed `NYANHUD` incorrect scaling
- Fixed OpenGL weapon alignment for wide weapons
- Rework transmap functionality
- Fix Software SSG fire "bleeding line" (fixed long standing PrBoom bug)
- Eliminate right-edge drift/jitter on long walls in Software (thanks to pvictress and International Doom)
...
- Fixed minimap when changing resolution / renderer
