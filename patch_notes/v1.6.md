...
> - Nyan Doom new uses some different libraries *(See "Compiliation Changes")*

**Improved Software Performance**
- Added Rum And Raisin's [Transposed Buffer](https://github.com/GooberMan/rum-and-raisin-doom/wiki/Transposed-Backbuffer)
...
**FOV Improvements**
- Added software FOV customisation (OpenGL already had this)
- Can be accessed in the "general" options
- Added "Zoom" keybind and FOV customisation (similar to Nugget Doom)

**Hexen**
- Added interpolation for Hexen PolyObjects and specific ceiling / floor movement actions.

**Added PNG -> Doom Format Graphic Support**
...
**Demo Compatibilty Update**
- "Extra Brightness" not being disabled on strict mode is now fixed
- "Vanilla Transparency" not being disabled on strict mode is now fixed

**New Menu Options**
- Added "UI Fade Effects" Option
...
- Added "Weapon Freelook Tilt" that tilts the weapon sprite based on the y-axis
  - Inspired by Quake
- Changed "Linear Sky" option to "Sky Projection" with 3 options
...
**Compiliation Changes**
- If you build Nyan Doom manually, note that there have been changes to the libraries / packages used:
  - SDL_Image has been removed in favour of sPNG
  - DiscordRPC has been added for Discord Integration support
- Take a look at the install / build instructions to see what's changed
