...
**New Menu Options**
- Added "Extra Menu Highlights" Option under "General -> Nyan" **(thanks Dinoaur for the suggestion)**
...
- Replaced "Freelook Enhanced Flying" with "Classic Flight"
  ...
  - Option is reversed now, with the default setting "no"
  - Forced to "yes" for demo recording
