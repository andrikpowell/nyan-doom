...
- "Play Random Music" feature is now applied in saved games
- Advanced Translucent Options are now disabled under Strict Mode

**Help Screen**
- Reworked Help / ReadMe screens to match DSDA-Doom (and removed Dynamic Help Screen)
...
- Armor / Berserk Indicators now only use the default lumps if found in a PWAD
  ...
  - Blue Armor off/on:  `STFARM20`/`STFARM20`
