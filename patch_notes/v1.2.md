...
- A simple UV Plus difficulty can be added instead by using a "M_ULTRAP" graphic lump, which when detected will add a new sixth UV Plus skill (UV placement + SpawnMulti)
