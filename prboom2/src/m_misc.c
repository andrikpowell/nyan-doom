...
cfg_def_t cfg_defs[] =
{
  ...
  SETTING_HEADING("Extended HUD Powerups Widget"),
  MIGRATED_SETTING(nyan_config_ex_powerup_widget),
  MIGRATED_SETTING(nyan_config_ex_powerup_blinking),
  MIGRATED_SETTING(nyan_config_ex_powerup_hide_duration),
  MIGRATED_SETTING(nyan_config_ex_powerup_armor),
  MIGRATED_SETTING(nyan_config_ex_powerup_berserk),
  MIGRATED_SETTING(nyan_config_ex_powerup_areamap),
  MIGRATED_SETTING(nyan_config_ex_powerup_backpack),
  MIGRATED_SETTING(nyan_config_ex_powerup_radsuit),
  MIGRATED_SETTING(nyan_config_ex_powerup_invis),
  MIGRATED_SETTING(nyan_config_ex_powerup_liteamp),
  MIGRATED_SETTING(nyan_config_ex_powerup_invuln),
  MIGRATED_SETTING(nyan_config_ex_powerup_flight),
  MIGRATED_SETTING(nyan_config_ex_powerup_tome),
  MIGRATED_SETTING(nyan_config_ex_powerup_speed),
  MIGRATED_SETTING(nyan_config_ex_powerup_morph),
  MIGRATED_SETTING(nyan_config_ex_powerup_maulator),
