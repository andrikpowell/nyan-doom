...
cfg_def_t cfg_defs[] =
{
  ...
  MIGRATED_SETTING(dsda_config_boom_translucent_missiles),
  MIGRATED_SETTING(dsda_config_boom_translucent_powerups),
  MIGRATED_SETTING(dsda_config_boom_translucent_effects),
  MIGRATED_SETTING(dsda_config_vanilla_translucent_sprites),
  MIGRATED_SETTING(dsda_config_vanilla_translucent_ghosts),
