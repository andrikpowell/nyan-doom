...
cfg_def_t cfg_defs[] =
{
  ...
  MIGRATED_SETTING(dsda_config_show_stat_totals),
  ...
  MIGRATED_SETTING(dsda_config_mapcolor_heretic_rkey),
  MIGRATED_SETTING(dsda_config_mapcolor_heretic_bkey),
  MIGRATED_SETTING(dsda_config_mapcolor_heretic_ykey),
  MIGRATED_SETTING(dsda_config_mapcolor_heretic_rdor),
  ...
  MIGRATED_SETTING(dsda_config_mapcolor_hexen_rkey),
  MIGRATED_SETTING(dsda_config_mapcolor_hexen_bkey),
  MIGRATED_SETTING(dsda_config_mapcolor_hexen_ykey),
  MIGRATED_SETTING(dsda_config_mapcolor_hexen_rdor),
  MIGRATED_SETTING(dsda_config_mapcolor_hexen_bdor),
  MIGRATED_SETTING(dsda_config_mapcolor_hexen_ydor),
  MIGRATED_SETTING(dsda_config_mapcolor_hexen_tele),
  MIGRATED_SETTING(dsda_config_mapcolor_hexen_secr),
  MIGRATED_SETTING(dsda_config_mapcolor_hexen_revsecr),
  MIGRATED_SETTING(dsda_config_mapcolor_hexen_tagfinder),
  MIGRATED_SETTING(dsda_config_mapcolor_hexen_exit),
  MIGRATED_SETTING(dsda_config_mapcolor_hexen_exitsecr),
