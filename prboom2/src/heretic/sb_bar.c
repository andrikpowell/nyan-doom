...
void SB_Drawer(dboolean statusbaron)
{
    ...
    if (heretic)
    {
        V_DrawNumPatchFullScreen(0, 158, 0, LumpBARBACK, CR_DEFAULT, VPT_STRETCH);
    ...
    {
        V_DrawNumPatchFullScreen(0, 134, 0, LumpH2BAR, CR_DEFAULT, VPT_STRETCH);
    }
...
void SB_DrawHorns(void)
{
    ...
    if (statusbaron && !dsda_HideHorns())
    {
        ...
        if (heretic)
        {
            V_DrawNumPatchFullScreen(0,  148, 0, LumpLTFCTOP, CR_DEFAULT, VPT_STRETCH);
            V_DrawNumPatchFullScreen(0,  148, 1, LumpLTFCTOP, CR_DEFAULT, VPT_STRETCH);
            V_DrawNumPatchFullScreen(290,  148, 0, LumpRTFCTOP, CR_DEFAULT, VPT_STRETCH);
            V_DrawNumPatchFullScreen(290,  148, 1, LumpRTFCTOP, CR_DEFAULT, VPT_STRETCH);
        }
        else
        {
            V_DrawNumPatchFullScreen(0, 134, 0, LumpH2TOP, CR_DEFAULT, VPT_STRETCH);
            V_DrawNumPatchFullScreen(0, 134, 1, LumpH2TOP, CR_DEFAULT, VPT_STRETCH);
        }
        V_EndUIDraw();
    }
}
...
void DrawCommonBar(void)
{
    ...
    if (oldhealth != HealthMarker)
    {
        ...
        if (heretic)
        {
            ...
            V_DrawNumPatchFullScreen(0,  190, 0, LumpCHAINBACK, CR_DEFAULT, VPT_STRETCH);
