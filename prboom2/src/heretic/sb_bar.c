...
void SB_DrawHorns(void)
{
    ...
    if (statusbaron && !dsda_HideHorns())
    {
        ...
        if (heretic)
        {
            ...
            V_DrawNumPatchFS(0,  148, 1, LumpLTFCTOP, CR_DEFAULT, VPT_STRETCH);
            V_DrawNumPatchFS(290,  148, 0, LumpRTFCTOP, CR_DEFAULT, VPT_STRETCH);
            V_DrawNumPatchFS(290,  148, 1, LumpRTFCTOP, CR_DEFAULT, VPT_STRETCH);
        }
        else
        {
            V_DrawNumPatchFS(0, 134, 0, LumpH2TOP, CR_DEFAULT, VPT_STRETCH);
            V_DrawNumPatchFS(0, 134, 1, LumpH2TOP, CR_DEFAULT, VPT_STRETCH);
        }
        V_EndUIDraw();
    }
}
