...
dsda_text_color_t dsda_text_colors[] = {
  ...
  [dsda_tc_exhud_ammo_none] = { "exhud_ammo_none", CR_TAN },
  ...
  [dsda_tc_exhud_powerup_invul] = { "exhud_powerup_invul", CR_GREEN },
  [dsda_tc_exhud_powerup_invis] = { "exhud_powerup_invis", CR_LIGHTBLUE },
  [dsda_tc_exhud_powerup_suit] = { "exhud_powerup_suit", CR_GRAY },
  [dsda_tc_exhud_powerup_light] = { "exhud_powerup_light", CR_GOLD },
  [dsda_tc_exhud_powerup_berserk] = { "exhud_powerup_berserk", CR_RED },
  [dsda_tc_exhud_powerup_allmap] = { "exhud_powerup_allmap", CR_BRICK },
  [dsda_tc_exhud_powerup_backpack] = { "exhud_powerup_backpack", CR_BROWN },
  [dsda_tc_exhud_powerup_armor_one] = { "exhud_powerup_armor_one", CR_GREEN },
  [dsda_tc_exhud_powerup_armor_two] = { "exhud_powerup_armor_two", CR_BLUE },
  [dsda_tc_exhud_powerup_flight] = { "exhud_powerup_flight", CR_GOLD },
  [dsda_tc_exhud_powerup_tome] = { "exhud_powerup_tome", CR_GRAY },
  [dsda_tc_exhud_powerup_speed] = { "exhud_powerup_speed", CR_BLUE },
  [dsda_tc_exhud_powerup_morph] = { "exhud_powerup_morph", CR_BRICK },
  [dsda_tc_exhud_powerup_maulator] = { "exhud_powerup_maulator", CR_RED },
  [dsda_tc_exhud_powerup_blink] = { "exhud_powerup_blink", CR_BLACK },
