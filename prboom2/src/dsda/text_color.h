...
typedef enum {
  ...
  dsda_tc_exhud_powerup_invul,
  dsda_tc_exhud_powerup_invis,
  dsda_tc_exhud_powerup_suit,
  dsda_tc_exhud_powerup_light,
  dsda_tc_exhud_powerup_berserk,
  dsda_tc_exhud_powerup_allmap,
  dsda_tc_exhud_powerup_backpack,
  dsda_tc_exhud_powerup_armor_one,
  dsda_tc_exhud_powerup_armor_two,
  dsda_tc_exhud_powerup_flight,
  dsda_tc_exhud_powerup_tome,
  dsda_tc_exhud_powerup_speed,
  dsda_tc_exhud_powerup_morph,
  dsda_tc_exhud_powerup_maulator,
  dsda_tc_exhud_powerup_blink,
  dsda_tc_hud_message,
