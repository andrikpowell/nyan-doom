...
void F_TextWrite (void)
{
  if (finalepatch)
  {
    ...
    V_DrawNameNyanPatchFullScreen(0, 0, 0, finalepatch, CR_DEFAULT, VPT_STRETCH);
  }
  else
...
void F_CastDrawer (void)
{
  ...
  // CPhipps - patch drawing updated
  V_DrawNameNyanPatchFullScreen(0,0,0, castbackground, CR_DEFAULT, VPT_STRETCH); // Ty 03/30/98 bg texture extern
...
void F_BunnyScroll (void)
{
...

  {
    ...
    if (scrolled <= 0) {
      V_DrawNameNyanPatchFullScreen(0, 0, 0, scrollpic2, CR_DEFAULT, VPT_STRETCH);
    } else if (scrolled >= 320) {
      V_DrawNameNyanPatchFullScreen(p1offset, 0, 0, scrollpic1, CR_DEFAULT, VPT_STRETCH);
      if (p1offset > 0)
        V_DrawNameNyanPatchFullScreen(-320, 0, 0, scrollpic2, CR_DEFAULT, VPT_STRETCH);
    } else {
      V_DrawNameNyanPatchFullScreen(p1offset + 320 - scrolled, 0, 0, scrollpic1, CR_DEFAULT, VPT_STRETCH);
      V_DrawNameNyanPatchFullScreen(-scrolled, 0, 0, scrollpic2, CR_DEFAULT, VPT_STRETCH);
    }
    if (p2width == 320)
...
void F_Drawer (void)
{
  ...
  else
  {
    ...
    if (finalelump)
    {
      ...
      V_DrawNameNyanPatchFullScreen(0, 0, 0, finalelump, CR_DEFAULT, VPT_STRETCH);
    }
  }
}
