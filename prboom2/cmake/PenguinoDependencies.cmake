...
if(STRICT_FIND)
  set(penguino_strict_keyword REQUIRED)
endif()

add_library(penguino_dependencies INTERFACE IMPORTED)
add_library(penguino::dependencies ALIAS penguino_dependencies)
...
if(WITH_IMAGE)
  find_package(SDL2_image ${penguino_strict_keyword})
  if(SDL2_image_FOUND)
...
if(WITH_MAD)
  find_package(mad ${penguino_strict_keyword})
  if(mad_FOUND)
...
if(WITH_FLUIDSYNTH)
  find_package(FluidSynth ${penguino_strict_keyword})
  if(FluidSynth_FOUND)
...
if(WITH_XMP)
  find_package(libxmp ${penguino_strict_keyword})
  if(libxmp_FOUND)
...
if(WITH_VORBISFILE)
  find_package(Vorbis ${penguino_strict_keyword})
...
if(WITH_PORTMIDI)
  find_package(PortMidi ${penguino_strict_keyword})
  if(PortMidi_FOUND)
...
add_library(penguino_SDL2 INTERFACE IMPORTED)
add_library(penguino::SDL2 ALIAS penguino_SDL2)

if(TARGET SDL2::SDL2main)
  get_target_property(sdl2_main_library SDL2::SDL2main LOCATION)
  if(EXISTS ${sdl2_main_library})
    target_link_libraries(penguino_SDL2 INTERFACE SDL2::SDL2main)
  endif()
endif()
...
if(EXISTS ${sdl2_library})
  target_link_libraries(penguino_SDL2 INTERFACE SDL2::SDL2)
elseif(EXISTS ${sdl2_static_library})
  target_link_libraries(penguino_SDL2 INTERFACE SDL2::SDL2-static)
else()
...
add_library(penguino_xmp INTERFACE IMPORTED)
add_library(penguino::xmp ALIAS penguino_xmp)

if(HAVE_LIBXMP)
  if(TARGET libxmp::xmp)
    target_link_libraries(penguino_xmp INTERFACE libxmp::xmp)
  else()
    target_link_libraries(penguino_xmp
      INTERFACE
...
target_link_libraries(penguino_dependencies
  INTERFACE
  OpenGL::GL
  OpenGL::GLU
  SndFile::sndfile
