...
set(PENGUINOPWADDIR "${default_wad_dir}" CACHE STRING "Path to install Pengunio Doom internal WAD")
set(DOOMWADDIR "${CMAKE_INSTALL_PREFIX}/${default_wad_dir}" CACHE PATH "Path to look for WAD files.")
set(PENGUINO_INSTALL_COPYRIGHT_DIR "${default_copyright_dir}" CACHE STRING "Destination of the copyright file")
set(PENGUINO_INSTALL_BINDIR "${default_bin_dir}" CACHE STRING "Destination of the penguino-doom binary")

option(ENABLE_PACKAGING "Enable creating CPack packages" ${penguino_is_top_project})
...
option(PENGUINO_NIGHTLY "Mark as nightly for demos" OFF)

option(CMAKE_FIND_PACKAGE_PREFER_CONFIG "Search for package config before using Find modules" ON)

if(IS_ABSOLUTE "${PENGUINOPWADDIR}")
    set(PENGUINO_ABSOLUTE_PWAD_PATH "${PENGUINOPWADDIR}")
else()
    set(PENGUINO_ABSOLUTE_PWAD_PATH "${CMAKE_INSTALL_PREFIX}/${PENGUINOPWADDIR}")
endif()
